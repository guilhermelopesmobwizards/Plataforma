...
class Metric(TimestampedModel):
    ...
    cost_ts_currency = models.CharField(max_length=10, null=True, blank=True)
    convs_google = models.IntegerField(null=True, blank=True)
    convs_mob = models.IntegerField(null=True, blank=True)
    revenue = models.DecimalField(max_digits=14, decimal_places=4, null=True, blank=True)
    revenue_currency = models.CharField(max_length=10, null=True, blank=True)
